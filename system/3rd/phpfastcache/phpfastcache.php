...
if (!function_exists("__c")) {
    ...
    /**
     *
     * @param string $storage $storage auto | pdo | mpdo | files | memcache | memcached | apc | wincache | xcache
     * @param array $option
     * @return phpFastCache
     */
...
if (!function_exists("phpFastCache")) {
    ...
    /**
     *
     * @param string $storage auto | pdo | mpdo | files | memcache | memcached | apc | wincache | xcache
     * @param array $option
     * @return phpFastCache
     */
